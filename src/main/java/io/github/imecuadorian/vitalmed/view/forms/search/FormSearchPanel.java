...
public class FormSearchPanel extends JPanel {
    ...
    private void init() {
        ...
        textSearch.putClientProperty(FlatClientProperties.TEXT_FIELD_LEADING_ICON, new FlatSVGIcon("io/github/imecuadorian/vitalmed/icon/search.svg", 0.4f));
        textSearch.putClientProperty(FlatClientProperties.STYLE, "border:3,3,3,3;" +
                "background:null;" +
    ...
    private class Item extends JButton {
        ...
        protected Component createRecentOption() {
            ...
            JButton cmdRemove = createButton("remove", "", 0.35f, "Label.foreground", 0.9f);
            if (!isFavorite) {
                JButton cmdFavorite = createButton("favorite", "", 0.4f, "Component.accentColor", 0.9f);
